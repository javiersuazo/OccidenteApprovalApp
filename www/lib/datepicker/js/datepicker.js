...
!function ($) {
    ...
    DatePicker.prototype = {
      ...
      , init: function () {
          ...
          $calendar.append('<div style="clear: left;"></div>');
          this.$picker = $('<div></div>')
          ...
          this.update(this.format(this.preSelectedDate));
      ...
      , selectMonth: function (date) {
          ...
          if (!this.curMonth || !(this.curMonth.getFullYear() == newMonth.getFullYear() &&
              ...
              for (var ii = 0; ii <= num_days; ii++) {
                  ...
                  var $day;
                  if (thisDay < new Date()) {
                      $day = $('<div></div>').attr('date', this.format(thisDay)).attr("disabled","disabled").addClass('overlap');
                      
                  } else {
                      $day = $('<div></div>').attr('date', this.format(thisDay));
                  }
              ...
              this.$days.find('div:not([disabled=disabled])').click($.proxy(function (e) {
                  var $targ = $(e.target);
